					...
					<div className="relative grid gap-8 md:grid-cols-2 md:items-center md:gap-12">
						...
						<div>
							...
							<p className="mt-4 text-sm leading-relaxed text-primary-foreground/75 sm:text-base">
								Whether you need to validate a product idea, track your brand
								health, or enter a new market — MerkMetryx delivers the
								intelligence you need before you commit. Request a personalised
								demo and see real insights from your industry.
							</p>
