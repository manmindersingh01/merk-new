...
const stats = [
	{
		...
		description: "Reaching verified respondents across 50+ countries",
	},
	{
		value: "48 hrs",
		label: "Average Turnaround",
		description: "From research brief to actionable insights report",
	},
	{
		value: "97%",
		label: "Data Accuracy Rate",
		description: "AI-validated responses with automated quality checks",
	},
	{
		value: "500+",
		label: "Research Projects Delivered",
		description: "Across retail, healthcare, and technology sectors",
	},
];
